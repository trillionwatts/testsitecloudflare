...
(function() {
							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Myronmanns',
										'page_location': 'https://trillionwattspublishing.com/#myronmanns',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Magazine',
										'page_location': 'https://trillionwattspublishing.com/#magazine',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'About',
										'page_location': 'https://trillionwattspublishing.com/#about',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Contact',
										'page_location': 'https://trillionwattspublishing.com/#contact',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Ty',
										'page_location': 'https://trillionwattspublishing.com/#ty',
									});
								},
							],
						},
					...
					'privacy-and-cookie-policy': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Privacy-and-cookie-policy',
										'page_location': 'https://trillionwattspublishing.com/#privacy-and-cookie-policy',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Home',
										'page_location': 'https://trillionwattspublishing.com',
									});
								},
							],
						},
	...
	// Slideshow: slideshow01.
		(function() {
			...
			new slideshowBackground('slideshow01', {
				...
				images: [
					{
						src: 'assets/images/slideshow01-50a23471.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow01-1ff392e1.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow01-ca36eec8.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow01-b67ed3bf.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow01-4a0431e8.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow01-4cc02916.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
	...
	// Initialize "On Visible" animations.
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 2, delay: 0, replay: true });
		onvisible.add('#image05', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 2, delay: 0, replay: true });
		onvisible.add('#icons01', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 2, delay: 0, replay: true });
		onvisible.add('.image.style1', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style9, h2.style9, h3.style9, p.style9', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style8, h2.style8, h3.style8, p.style8', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 2, delay: 0, replay: true });
		onvisible.add('#text01', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.image.style4', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#image04', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style6, h2.style6, h3.style6, p.style6', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 2, delay: 0, replay: false });
		onvisible.add('#text14', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 2, delay: 0, replay: false });
		onvisible.add('#text16', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 2, delay: 0, replay: true });
		onvisible.add('#text10', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style13, h2.style13, h3.style13, p.style13', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text12', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text22', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container22', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style7, h2.style7, h3.style7, p.style7', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#form02', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text18', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style12, h2.style12, h3.style12, p.style12', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container14', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container17', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container27', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container20', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container15', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container25', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container18', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container10', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container26', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container19', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container12', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container04', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container02', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container09', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container23', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container16', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container24', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
